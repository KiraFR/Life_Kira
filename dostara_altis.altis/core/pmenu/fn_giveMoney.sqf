...
if(_amount <= 0) exitWith {hint "You need to enter an actual amount you want to give.";ctrlShow[2001,true];};
if(_amount > CASH) exitWith {hint "Vous n'avez pas assez d'argent !";ctrlShow[2001,true];};
if(isNull _unit) exitWith {ctrlShow[2001,true];};
