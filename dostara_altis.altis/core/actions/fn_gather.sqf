...
switch(true) do {
	...
	case (_zone in ["wine_1","wine_2"]): {_gather = "Raisin"; _val = 3; _object = "Seau";};
	case (_zone in ["Ress_Bois_01","Ress_Bois_02","Ress_Bois_03","Ress_Bois_04"]): {_gather = "Bois"; _val = floor(random(4)); _object = "Hache";};
	case (_zone in ["Ress_Sable_02","Ress_Sable_01"]): {_gather = "Sable"; _val = floor(random(5)); _object = "Pelle";};
	case (_zone in ["Ress_Raisin_01","Ress_Raisin_02"]): {_gather = "Raisin"; _val = floor(random(5)); _object = "Seau";};
	case (_zone in ["Ress_Alu_01","Ress_Alu_02"]): {_gather = "Aluminium_Brut"; _val = floor(random(3)); _object = "Pioche";};
	case (_zone in ["Ress_Orange_01","Ress_Orange_02"]): {_gather = "Orange"; _val = floor(random(3)); _object = "Seau";};
	...
	case (_zone in ["Ress_PP_01"]): {_gather = "Pierres_Precieuses"; _val = floor(random(3)); _object = "Pioche";};
	case (_zone in ["Ress_Petrole_01"]): {_gather = "Petrole"; _val = floor(random(3)); _object = "Seau";};
