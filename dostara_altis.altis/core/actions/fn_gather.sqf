...
switch(true) do {
	...
	case (_zone in ["Ress_Bois_01"]): {_gather = "Bois"; _val = floor(random(4)); _object = "";_lis = "license_civ_wood_01";};
	case (_zone in ["Ress_Bois_02"]): {_gather = "Bois"; _val = floor(random(4)); _object = "";_lis = "license_civ_wood_02";};
	case (_zone in ["Ress_Bois_03"]): {_gather = "Bois"; _val = floor(random(4)); _object = "";_lis = "license_civ_wood_03";};
	case (_zone in ["Ress_Bois_04"]): {_gather = "Bois"; _val = floor(random(4)); _object = "";_lis = "license_civ_wood_04";};
	...
	case (_zone in ["Cannabis_01","Cannabis_02","Cannabis_03"]): {_gather = "Cannabis"; _val = floor(random(3)); _object = "";};
	case (_zone in ["Coca_01","Coca_02"]): {_gather = "Coca"; _val = floor(random(3)); _object = "";};
	case (_zone in ["Pavot_01","Pavot_02"]): {_gather = "Opium"; _val = floor(random(3)); _object = "";};
	default {""};
};
//gather check??
