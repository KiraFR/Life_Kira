...
if(local _vehicle) then {
	...
	{
		case "C_Offroad_01_F": {[_vehicle,"color",3,true] RemoteExecCall ["TON_fnc_setObjVar",2];};
		case "C_Hatchback_01_F": {[_vehicle,"color",1,true] RemoteExecCall ["TON_fnc_setObjVar",2];};
		case "C_Hatchback_01_sport_F": {[_vehicle,"color",1,true] RemoteExecCall ["TON_fnc_setObjVar",2];};
		case "C_SUV_01_F": {[_vehicle,"color",1,true] RemoteExecCall ["TON_fnc_setObjVar",2];};
		case "C_Van_01_box_F": {[_vehicle,"color",1,true] RemoteExecCall ["TON_fnc_setObjVar",2];};
		case "C_Van_01_transport_F": {[_vehicle,"color",1,true] RemoteExecCall ["TON_fnc_setObjVar",2];};
	};
};
