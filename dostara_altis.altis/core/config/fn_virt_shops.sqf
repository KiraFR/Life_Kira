...
switch (_shop) do
{
	case "marche": {["Marché",["Orange","Peche","Pommes","Raisin","Bouteille_d_eau","Jus_de_raisin","Jus_de_pommes","Jus_Multisfruits","Wrap_Poulet","Big_Burger","Soda_Extra_Energy_Drink","Soupe_de_poisson"]]};
    ...
    case "Dealer" : {["Dealer",["Canabis","Coca","Opium","Cocaine","Heroine","Shit","Meth","Speed_Ball"]]};
