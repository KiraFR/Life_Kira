...
[] spawn
{
	...
	{
		[0,"STR_Cop_Ticket_Refuse",true,[profileName]],RemoteExec ["life_fnc_broadcast",west];
		[1,"STR_Cop_Ticket_Refuse",true,[profileName]],RemoteExec ["life_fnc_broadcast",life_ticket_cop];
	};
};