...
case "Orange" : {[              1,      5,      3,      0.1,    0,      0,      [["Peche",0.1],["apple",0.1],["Raisin",0.1],["Jus_Multisfruits",0.2]]]};
case "Peche" : {[               1,      5,      3,      0.1,    0,      0,      [["Orange",0.1],["apple",0.1],["Raisin",0.1],["Jus_Multisfruits",0.2]]]};
case "apple" : {[               1,      5,      3,      0.1,    0,      0,      [["Peche",0.1],["Orange",0.1],["Raisin",0.1],["Jus_de_pommes",0.4]]]};
case "Raisin" : {[              1,      5,      3,      0.1,    0,      0,      [["Peche",0.1],["apple",0.1],["Orange",0.1],["Jus_de_raisin",0.4]]]};
...
case "Aluminium" : {[           1,     -1,      33,     0.2,    0,      0,      [["Argent",0.1],["Charbon",0.2],["Cuivre",0.1],["Fer",0.2],["Acier",0.3]]]};
case "Argent" : {[              1,     -1,      35,     0.2,    0,      0,      [["Aluminium",0.1],["Cuivre",0.1],["Fer",0.1],["Pierres_Precieuses",0.5],["Bijoux",0.3]]]};
case "Bois" : {[                1,     -1,      18,     0.3,    0,      0,      [["Charbon",0.1],["Chaux",0.1],["Cuivre",0.1],["Fer",0.1],["Petrole",0.1],["Sable",0.1],["Verre",0.1],["Acier",0.1],["Ciment",0.1],["Essence",0.1]]]};
case "Charbon" : {[             1,     -1,      22,     0.2,    0,      0,      [["Aluminium",0.2],["Bois",0.1],["Fer",0.2],["Petrole",0.1],["Acer",0.3],["Essence",0.1]]]};
...
case "Fer" : {[                 1,     -1,      27,     0.1,    0,      0,      [["Aluminium",0.2],["Argent",0.1],["Bois",0.1],["Charbon",0.2],["Chaux",0.1],["Cuivre",0.1],["Sable",0.1],["Verre",0.1],["Acier",0.3],["Ciment",0.1]]]};
case "Petrole" : {[             1,     -1,      35,     0.2,    0,      0,      [["Bois",0.1],["Charbon",0.1],["Essence",0.1]]]};
...
case "Acier" : {[               1,     -1,      61,     0.1,    0,      0,      [["Aluminium",0.2],["Charbon",0.2],["Fer",0.2],["Ciment",0.1]]]};
...
case "Name" : {["Orange","Peche","apple","Raisin","Jus_Multisfruits","Jus_de_pommes","Jus_de_raisin","Cidre","Vin","Biere","Wisky","Cafe","Tabac","Saupe","Girelle","Maquereau","Thon","Mulet","Roussette","Soupe_de_poisson","Aluminium","Argent" ,"Bois","Charbon","Chaux","Cuivre","Fer","Petrole","Pierres_Precieuses","Sable","Sel","Verre","Acier","Bijoux","Ciment","Essence","Canabis","Cocaine","Opium","Cocaine","Heroine","Shit" ,"Meth","Pharmaceutique","Speed_Ball","Tortue"]};
