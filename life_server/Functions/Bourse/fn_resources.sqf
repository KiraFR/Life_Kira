...
case "coffee" : {[                1,      0,      0,      0,      0,      0,      [["Tabac",0.5]]]};
case "Tabac" : {[               1,      0,      0,      0,      0,      0,      [["coffee",0.5]]]};
...
case "Aluminium" : {[           1,      0,      33,     0.2,    0,      0,      [["Argent",0.1],["Charbon",0.2],["copper_r",0.1],["iron_r",0.2],["Acier",0.3]]]};
case "Argent" : {[              1,      0,      35,     0.2,    0,      0,      [["Aluminium",0.1],["copper_r",0.1],["iron_r",0.1],["diamondc",0.5],["diamond",0.3]]]};
case "Bois" : {[                1,      0,      18,     0.3,    0,      0,      [["Charbon",0.1],["Chaux",0.1],["copper_r",0.1],["iron_r",0.1],["oilp",0.1],["Sable",0.1],["glass",0.1],["Acier",0.1],["cement",0.1],["fuelF",0.1]]]};
case "Charbon" : {[             1,      0,      22,     0.2,    0,      0,      [["Aluminium",0.2],["Bois",0.1],["iron_r",0.2],["oilp",0.1],["Acer",0.3],["fuelF",0.1]]]};
case "Chaux" : {[               1,      0,      21,     0.2,    0,      0,      [["Bois",0.1],["copper_r",0.1],["iron_r",0.1],["Sable",0.2],["glass",0.1],["Acier",0.1],["cement",0.3]]]};
case "copper_r" : {[              1,      0,      24,     0.2,    0,      0,      [["Aluminium",0.1],["Argent",0.1],["Bois",0.1],["Chaux",0.1],["iron_r",0.1],["Salbe",0.1],["glass",0.1],["Acier",0.1],["cement",0.1]]]};
case "iron_r" : {[                 1,      0,      27,     0.1,    0,      0,      [["Aluminium",0.2],["Argent",0.1],["Bois",0.1],["Charbon",0.2],["Chaux",0.1],["copper_r",0.1],["Sable",0.1],["glass",0.1],["Acier",0.3],["cement",0.1]]]};
case "oilp" : {[             1,      0,      35,     0.2,    0,      0,      [["Bois",0.1],["Charbon",0.1],["fuelF",0.1]]]};
case "diamondc" : {[  1,      0,      43,     0.1,    0,      0,      [["Argent",0.2],["diamond",0.3]]]};
case "Sable" : {[               1,      0,      17,     0.3,    0,      0,      [["Bois",0.1],["copper_r",0.1],["iron_r",0.1],["glass",0.3],["Acier",0.1],["cement",0.1]]]};
case "salt_r" : {[                 1,      0,      18,     0.3,    0,      0,      [["ornate",0.2],["mackerel",0.2],["tuna",0.2],["mullet",0.2],["catshark",0.2],["salema",0.2],["turtlesoup",0.2],["turtle",0.2]]]};
case "glass" : {[               1,      0,      31,     0.3,    0,      0,      [["Bois",0.1],["Chaux",0.1],["copper_r",0.1],["iron_r",0.1],["Sable",0.3],["Acier",0.1],["cement",0.1]]]};

case "Acier" : {[               1,      0,      61,     0.1,    0,      0,      [["Aluminium",0.2],["Charbon",0.2],["iron_r",0.2],["cement",0.1]]]};
case "diamond" : {[              1,      0,      70,     0.1,    0,      0,      [["Argent",0.2],["diamondc",0.1]]]};
case "cement" : {[              1,      0,      38,     0.1,    0,      0,      [["Chaux",0.2],["Sables",0.2],["Acier",0.2]]]};
...
case "Cocaine" : {[             1,      0,      45,     0.2,    0,      0,      [["cocainep",0.2],["Shit",0.1],["marijuana",0.1],["heroinp",0.1],["Pharmaceutique",0.1],["Meth",0.1],["Speedball",0.3]]]};
case "heroinp" : {[             1,      0,      51,     0.2,    0,      0,      [["opium",0.2],["Shit",0.1],["marijuana",0.1],["Cocaine",0.1],["Pharmaceutique",0.1],["Meth",0.1],["Speedball",0.3]]]};
case "Shit" : {[                1,      0,      40,     0.2,    0,      0,      [["marijuana",0.2],["Cocaine",0.1],["heroinp",0.1],["Pharmaceutique",0.1],["Meth",0.1],["Speedball",0.1],["turtle",0.1]]]};

case "Meth" : {[                1,      0,      82,     0.1,    0,      0,      [["glass",0.2],["marijuana",0.1],["opium",0.1],["Pharmaceutique",0.2],["Speedball",0.1]]]};
case "Pharmaceutique" : {[      1,      0,      57,     0.1,    0,      0,      [["glass",0.2],["marijuana",0.1],["opium",0.1],["Meth",0.2],["Speedball",0.1]]]};
case "Speedball" : {[           1,      0,      76,     0.2,    0,      0,      [["glass",0.2],["marijuana",0.1],["opium",0.1],["Meth",0.2],["Pharmaceutique",0.1]]]};
