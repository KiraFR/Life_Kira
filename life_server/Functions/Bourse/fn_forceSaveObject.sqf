...
private["_Object","_ObjectLast","_Object2","_Object_Bourse","_valueModif","_minFor","_maxFor","_Sell","_Sell_2","_Resources","_Resource_2","_Id_Object2","_newValueArray","_Object_Bourse","_resource","_count","_ent","_ownerID","_result","_valueNew","_prix","_min","_max","_seil","_evol","_entValue","_relation","_value","_name"];
    ...
    if (!(_ObjectLast isEqualTo _Object)) then {
...

        {
            ...
            if (_countArr != 0) then {
                ...
                _value = {if (_resource == (_x select 0)) exitWith {(_x select 1)}}forEach _Object_Bourse_Bourse;
                if (_ent) then {
                    if (_entValue != 0) then {
