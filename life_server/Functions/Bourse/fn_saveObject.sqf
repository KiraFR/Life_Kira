/*
	...
	returns: nothing
*/
private["_Object","_ObjectLast","_Object2","_Sell","_Sell_2","_ressources","_ressource_2","_Id_Object2","_newValueArray","_Object_Bourse","_ressource","_count","_ent","_ownerID","_result","_valueNew","_prix","_min","_max","_seil","_evol","_entValue","_relation","_value","_name"];
uiSleep 5;
while {true} do {
