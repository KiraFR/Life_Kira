...
*/
_prefixe = param[0,"",[""],["_player",objNull,[objNull]]];
...
while {((count (_fiveNumber splitString "")) != 5) || ((_allnumber find [_fiveNumber]) != -1)} do {
	_fiveNumber = floor(random(99999));
	_fiveNumber = str(_fiveNumber);
...
[format["INSERT INTO phonenumber(pid_owner,numero,active) VALUES(%1,%2,'1');",getPlayerUID _player,format["%1%2",_prefixe,_fiveNumber]],1] call DB_fnc_asyncCall;
_player setVariable ["phonenumber",format["%1%2",_prefixe,_fiveNumber]];